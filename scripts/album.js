...
var previousSong = function() {
 ...
 var $playerPause = $('.main-controls .play-pause');
...
var togglePlayFromPlayerBar = function () {
  ...
  // play the song
  // show the pause icon in the player bar
  // show the pause icon in the song row
...
$(document).ready(function() {
     ...
     $playerPause.click(togglePlayFromPlayerBar)
